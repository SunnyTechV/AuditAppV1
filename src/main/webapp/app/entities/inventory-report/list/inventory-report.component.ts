...
export class InventoryReportComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.inventoryReportService
      ...
      .subscribe(
        (res: HttpResponse<IInventoryReport[]>) => {
  ...
  trackId(index: number, item: IInventoryReport): number {
    return item.id!;
  }

  delete(inventoryReport: IInventoryReport): void {

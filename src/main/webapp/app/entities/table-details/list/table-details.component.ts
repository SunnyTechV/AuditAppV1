...
export class TableDetailsComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.tableDetailsService
      ...
      .subscribe(
        (res: HttpResponse<ITableDetails[]>) => {
  ...
  trackId(index: number, item: ITableDetails): number {
    return item.id!;
  }

  delete(tableDetails: ITableDetails): void {
    const modalRef = this.modalService.open(TableDetailsDeleteDialogComponent, {
      size: "lg",
      backdrop: "static",
    });
